import { IIconProps } from "../domain/Props";

export default function EditIcon({ className, color }: IIconProps): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="12" height="12" fill={color ?? "currentColor"} className={className}>
